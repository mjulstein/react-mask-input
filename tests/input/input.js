...
function createInput(root, component) {
  let { props } = component;
...
describe("react-input-mask", () => {
  ...
  it("should show placeholder on focus", async () => {
    const { input } = createInput(root, <Input mask="+7 (*a9) 999 99 99" />);
  ...
  it("should format value in onChange (with maskPlaceholder)", async () => {
    const { input } = createInput(root, <Input mask="**** **** **** ****" />);
  ...
  it("shouldn't affect value if mask is empty", async () => {
    const { input, setProps } = createInput(root, <Input value="12345" />);
  ...
  it("should handle transition between masked and non-masked state", async () => {
    const { input, setProps } = createInput(root, <Input />);
    setProps({
      value: "",
      onChange: event => {
        setProps({
  ...
  it.skip("should handle regular component as children", async () => {
  ...
  it.skip("should handle functional component as children", async () => {
    let { input } = createInput(
      root,
      <Input mask="+7 (999) 999 99 99">
  ...
  it.skip("should handle children change", async () => {
    let { input, setProps } = createInput(
      root,
      <Input mask="+7 (999) 999 99 99" />
    );
  ...
  it.skip("should handle change event without focus", async () => {
    const { input } = createInput(
      root,
  ...
  it.skip("shouldn't move cursor on delayed value change", async () => {
    const { input, setProps } = createInput(
      root,
      <Input mask="+7 (999) 999 99 99" maskPlaceholder={null} />
    );
